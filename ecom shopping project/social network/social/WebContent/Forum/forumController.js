app.controller("forumController", function($scope, $http, $location) {
	function fetchAllForum() {
		...
		$http.get("http://localhost:8090/AppRest/getAllForums")
	...
	$scope.insertForum = function() {
		...
		$http.post('http://localhost:8090/SAppRest/insertForum',
	...
	$scope.deleteForum=function(forumId)
	{
		...
		$http.get("http://localhost:8090/AppRest/deleteForum/"+forumId)
